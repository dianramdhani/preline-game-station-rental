export default function Modal() {
  return (
    <div>
      ...
      >
        <div className='m-3 transition-all opacity-0 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 sm:max-w-lg sm:w-full sm:mx-auto'>
          <div className='flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]'>
            <div className='flex items-center justify-between px-4 py-3 border-b dark:border-gray-700'>
              ...
              <button
                type='button'
                className='inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-sm text-gray-500 transition-all rounded-md hover:text-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-gray-700 dark:focus:ring-offset-gray-800'
                data-hs-overlay='#hs-basic-modal'
              >
